...
namespace QDMSServer
{
    ...
    public partial class App : Application
    {
        ...
        {
            if (Directory.Exists(QDMSServer.Properties.Settings.Default.logDirectory))
            {
                ((FileTarget)LogManager.Configuration.FindTargetByName("default")).FileName = QDMSServer.Properties.Settings.Default.logDirectory + "Log.log";
            }
        }
