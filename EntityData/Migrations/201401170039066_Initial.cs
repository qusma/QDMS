    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                {
                    ID = c.Int(nullable: false, identity: true),
                    Symbol = c.String(unicode: false, maxLength: 255),
                    UnderlyingSymbol = c.String(unicode: false),
                    Name = c.String(unicode: false, maxLength: 255),
                    ...
                    Currency = c.String(unicode: false, maxLength: 20),
                    MinTick = c.Decimal(precision: 16, scale: 8),
                    Industry = c.String(unicode: false, maxLength: 100),
                    Category = c.String(unicode: false, maxLength: 100),
                    Subcategory = c.String(unicode: false, maxLength: 100),
                    ...
                    DatasourceSymbol = c.String(unicode: false, maxLength: 255),
                })
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.ContinuousFutures", t => t.ContinuousFutureID, cascadeDelete: true)
            ...
            CreateTable(
                ...
                c => new
                {
                    ...
                    LongName = c.String(unicode: false, maxLength: 255),
                })
                .PrimaryKey(t => t.ID);
            ...
            CreateTable(
                ...
                {
                    ID = c.Int(nullable: false, identity: true),
                    Name = c.String(unicode: false, maxLength: 100),
                })
                .PrimaryKey(t => t.ID);
